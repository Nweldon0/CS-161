...
if wone == "months":
    ...
    #The plan here is just to take the number of days in each month and multiply that by how many seconds are in each day
    if mmonth != 2:
        print(f"The current month is {mmonth2}. The number of seconds in this month is {mseconds * 86400}.")
    else:
        ...
        if myear % 4 == 0:
            ...
            myear = "is not"
            mseconds = 28
        print(f"The current month is February. It {myear} a leap year, therefore the number of seconds this February is {mseconds * 86400}.")
